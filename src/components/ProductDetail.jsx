        ...
        <div className="pt-[20px] w-full max-w-[400px] sm:max-w-[600px]">
          ...
          <div className="">
            ...
            <div  className="flex items-center gap-[10px]"> 
              ...
              <div className="like-wrapper w-12 h-12 p-2 rounded-lg border border-neutral-900/opacity-50 flex-col justify-center items-center gap-2 inline-flex">
              ...
              <button className=" w-12 h-12 p-2 rounded-lg border border-neutral-900/opacity-50 flex-col justify-center items-center gap-2 inline-flex hover:bg-blue">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
